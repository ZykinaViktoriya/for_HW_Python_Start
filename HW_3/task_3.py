# Была выполнена 3 задача из домашнего задания номер 3.
# В настольной игре Скрабл (Scrabble) каждая буква имеет определенную ценность. 
# В случае с английским алфавитом очки распределяются так:                    А русские буквы оцениваются так:
# ● A, E, I, O, U, L, N, S, T, R – 1 очко;                                    ● А, В, Е, И, Н, О, Р, С, Т – 1 очко;
